...
MainFontFile = resource_path("MtSerdian-Regular.ttf")
SecondaryFontFile = resource_path("ClashGrotesk-Regular.ttf")
...
StartImage = ctk.CTkImage(dark_image=Image.open(resource_path('start.png')), light_image=Image.open(resource_path('start.png')), size=(20, 20))
StopImage = ctk.CTkImage(dark_image=Image.open(resource_path('stop.png')), light_image=Image.open(resource_path('stop.png')))
...
#Skip Button
SkipImage = ctk.CTkImage(dark_image=Image.open(resource_path('skip.png')), light_image=Image.open(resource_path('skip.png')), size=(20, 22))
...
OptionsImage = ctk.CTkImage(dark_image=Image.open(resource_path('options.png')), light_image=Image.open(resource_path('options.png')), size=(22, 25))
...
#Icons
MinusIcon = ctk.CTkImage(dark_image=Image.open(resource_path('minus.png')), light_image=Image.open(resource_path('minus.png')), size=(15, 15))
PlusIcon = ctk.CTkImage(dark_image=Image.open(resource_path('plus.png')), light_image=Image.open(resource_path('plus.png')), size=(15, 15))
#Options - Focus
